"""Script for running the linear-bilinear model on training and validation data. 
...
def arg_parser() -> 'argparse.Namespace':
    ...
    parser = argparse.ArgumentParser(
        ...
        '''
description:
    Script for running the linear-bilinear model on training and validation data. Saves the fitting history in the destionation path provided.
