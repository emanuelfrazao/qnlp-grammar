"""Script for running the perceptron on training and validation data. 
...
from modules.modelling.models.neuralnetworks import Perceptron
...
def main(args):
    ...
    # # Train model
    model = Perceptron(len(context_base), args.hidden_dim, args.dropout)
...
def arg_parser() -> 'argparse.Namespace':
    ...
    parser = argparse.ArgumentParser(
        ...
        '''
description:
    Script for running the perceptron model on training and validation data. Saves the fitting history in the destionation path provided.
    
example:
    python .\model_scripts\perceptron_training.py 
